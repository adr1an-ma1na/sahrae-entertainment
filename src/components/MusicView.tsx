...
export default function MusicView() {
  ...
  //    On Repeat, Daily Mixes, Discover Weekly, Release Radar. ──
  useEffect(() => {
    ...
    (async () => {
      ...
      // On Repeat — your actual recent rotation.
      ...
      // Daily Mixes — each seeded from a different track for a distinct vibe.
      ...
      // Discover Weekly — related songs you HAVEN'T heard yet, shuffled.
      ...
      // Release Radar — latest from your top artists (slower; appended after).
