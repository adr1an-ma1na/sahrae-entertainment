      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-3 md:gap-5">
        {items.map((item) => {
          ...
          return (
            <div 
              key={`${type}-${item.id}`} 
              className="relative aspect-[2/3] rounded-xl overflow-hidden group cursor-pointer bg-zinc-900 border border-white/5 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(245,158,11,0.15)] hover:border-white/20 hover:z-10"
